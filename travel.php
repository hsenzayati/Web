...
$conn = mysqli_connect('localhost', 'root', '', 'commend');
...
$sql = "INSERT INTO travel (place,date,nbp) VALUES ('$place', '$date', '$nbp')";
...
<section class="about" id="about">
    ...
    <div class="video-container" data-aos="fade-right" data-aos-delay="300">
        <video src="-1.mp4" data-aos-delay="300" muted autoplay loop class="video"></video>
        <div class="controls">
            <span class="control-btn" data-src="-1.mp4"></span>
            <span class="control-btn" data-src="-2.mp4"></span>
            <span class="control-btn" data-src="-0.mp4"></span>
        </div>
    </div>
...
<section class="destination" id="destination">
    ...
    <div class="box-container">
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="150">
            ...
            <div class="content">
                <h3>Paris</h3>
                <p>Paris is one of the most best destination in the World</p>
                <a href="paris.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="content">
                <h3>London</h3>
                <p>Paris is one of the most best destination in the World</p>
                <a href="london.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="450">
            ...
            <div class="content">
                <h3>Omar</h3>
                <p>Omar is one of the most best destination in the World  </p>
                <a href="omar.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
        <div class="box" data-aos="fade-up" data-aos-delay="600">
            ...
            <div class="content">
                <h3>Tunise</h3>
                <p>Tunise is one of the most best destination in the World</p>
                <a href="Tunisie.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="750">
            ...
            <div class="content">
                <h3>brazil</h3>
                <p>brazil is one of the most best destination in the World</p>
                <a href="brazil.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="900">
            ...
            <div class="content">
                <h3>maldive</h3>
                <p>maldive is one of the most best destination in the World</p>
                <a href="maldive.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="1150">
            ...
            <div class="content">
                <h3>berlin</h3>
                <p>berlin is one of the most best destination in the World.</p>
                <a href="berlin.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="1300">
            ...
            <div class="content">
                <h3>suisse</h3>
                <p>suisse is one of the most best destination in the World.</p>
                <a href="sussie.html">read more <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="450">
            ...
            <p> <i class="fas fa-envelope"></i> NourHene02@gmail.com </p>
